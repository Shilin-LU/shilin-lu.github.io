...
##### **Research Interests**
In the past, my work has centered on how to guide generative models through test-time interventions or fine-tuning to expand or reshape their capabilities. With test-time interventions, I explored ways to influence the sampling process so that general text-to-image models could adapt to new tasks (e.g., text-driven image editing, object insertion, drag-based editing, etc.). With fine-tuning and post-training, I experimented with adjusting a model’s internal concept representations so that when it generates a particular idea, the result aligns more closely with our intended meaning.
...
Seen from a distance, all these explorations point toward a shared pursuit: understanding how to shape the abilities and internal concepts of generative models so they can create and interpret the worlds we ask of them with greater precision and coherence.
